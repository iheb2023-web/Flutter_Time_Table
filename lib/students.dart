  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.purple, Colors.blue],  // Dégradé violet et bleu
                      ...
                      return Card(
                        child: ListTile(
                          title: Text(
                            ...
                            style: TextStyle(fontFamily: 'Roboto'),  // Appliquer la police personnalisée
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Colors.purple,  // Couleur du bouton flottant
      ),
    );
  }
}
